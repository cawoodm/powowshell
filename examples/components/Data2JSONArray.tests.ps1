...
($arr | & $Me -Compress)
if (($arr | & $Me -Compress) -eq $json) {Write-Host "SUCCESS: Data2JSON: Basic array test passed" -ForegroundColor Green} else {Write-Host "FAIL: Data2JSON: Basic array test failed" -ForegroundColor Red}